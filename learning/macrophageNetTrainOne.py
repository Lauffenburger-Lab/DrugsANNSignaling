...
# outPattern = outPattern + str(args.lamda)
...
torch.save(model, '../results/FinalEnsemble/models/'+cell+'_'+outPattern+'.pt')
...
plt.xlabel('Epoch')
plt.yscale('log')
plt.savefig('../results/FinalEnsemble/train/fig1_'+cell+'_'+outPattern+'.png',dpi=600)
#
plt.figure()
...
plt.xlabel('Epoch')
plt.savefig('../results/FinalEnsemble/train/fig2_'+cell+'_'+outPattern+'.png',dpi=600)
#
plt.figure()
...
plt.xlabel('Epoch')
plt.savefig('../results/FinalEnsemble/train/fig3_'+cell+'_'+outPattern+'.png',dpi=600)
...
plt.savefig('../results/FinalEnsemble/train/fig4_'+cell+'_'+outPattern+'.png',dpi=600)
...
plt.hist(srModel)
plt.ylabel('SR model')
plt.savefig('../results/FinalEnsemble/train/fig6_'+cell+'_'+outPattern+'.png')
plt.rcParams["figure.figsize"] = (12,10)
plt.figure()
rank = plotting.compareAllTFs(Yhat, Y, outNameGene)
plt.savefig('../results/FinalEnsemble/train/fig7_'+cell+'_'+outPattern+'.png',dpi=600)
plt.figure()
rank = plotting.compareAllTFs(Yhat.T, Y.T, sampleName)
plt.savefig('../results/FinalEnsemble/train/fig8_'+cell+'_'+outPattern+'.png',dpi=600)
plotting.displayData(Y, sampleName, outNameGene)
plt.savefig('../results/FinalEnsemble/train/fig9_'+cell+'_'+outPattern+'.png',dpi=600)