...
parser.add_argument('--PKN', action='store', default='data/l1000_lvl3_withsignor-Model.tsv')
parser.add_argument('--PknAnnotation', action='store', default='data/l1000_lvl3_withsignor-Annotation.tsv')
